...
async function searchMangaTags(msg) {
  ...
  writeFile(`${tagsPath}/mangaTags.json`, JSON.stringify(tagModelList, null, 2), err => {
    if (err) throw new Error("Something went wrong with 'mangaTags.json' !");

    msg.reply("tags adicionadas com sucesso! Tente usar o 'gibi tags' para visualizá-las.")
  })
